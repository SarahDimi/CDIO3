...
public class BrownField extends Field {
    ...
    @Override
    protected boolean isColorGroupOwned() {
        // Implement logic to check if the entire color group is owned by the same player

        return isOwned && isOtherFieldOwned();
    }

    @Override
    protected boolean isOtherFieldOwned() {
        // Implement logic to check if the other field in the color group is owned
        // Return true if the other field is owned, false otherwise
